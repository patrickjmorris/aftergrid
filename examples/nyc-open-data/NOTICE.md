...
fetches it from the publishers' own endpoints. The terms below are the publishers', summarized for orientation —
...
Trip records are collected and provided to the TLC by authorized technology providers. The TLC publishes them
...
Terms: U.S. Government work, in the public domain; the NOAA Open Data Dissemination program publishes it under
...
and Findings — are part of aftergrid and are licensed under the MIT License, the same as the rest of this
repository. See [`LICENSE`](../../LICENSE). That license covers these files only; it grants no rights in the
