...
Inspect the [input CSV](https://github.com/patrickjmorris/aftergrid/blob/main/examples/skills-lab/data/conversion.csv), [case brief](https://github.com/patrickjmorris/aftergrid/blob/main/examples/skills-lab/cases/conversion.md), and [verification code](https://github.com/patrickjmorris/aftergrid/blob/main/examples/skills-lab/verify.mjs). Then try the [lesson-reuse follow-up](lesson-reuse.md), where conversion recovers and the earlier explanation must be tested again. [Analysis that compounds](../fieldnotes/analysis-that-compounds.md) explains how to carry a useful lesson into that second question.
