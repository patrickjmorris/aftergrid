...
- **Success test for v0:** a non-data person at Spot Sports makes a decision from a rendered Finding without a clarifying question to the Operator, and golden Questions are green in CI.
