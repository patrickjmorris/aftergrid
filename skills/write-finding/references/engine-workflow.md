...
[`references/outcomes.md`](outcomes.md) before writing any prose.
...
number is. Read [`references/claim-typing.md`](claim-typing.md).
...
external source. Read [`references/evidence-binding.md`](evidence-binding.md), then declare, in
this order:
