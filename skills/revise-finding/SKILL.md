---
name: revise-finding
description: Take an Operator's feedback on a reviewed Finding, classify it as presentation, interpretation or numeric, and apply it as a new revision or say what it reopens. Use for "make it horizontal", "lead with retention", "reword the answer", or any edit to a Finding that has already been checked.
