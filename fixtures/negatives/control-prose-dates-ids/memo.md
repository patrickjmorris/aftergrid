---
finding: fnd_hbd5tecbg68m
revision: 1
---

# 1. New users who got the onboarding checklist came back more often
...
- Control line for the numeral rule: a date (2026-06-01), a timestamp (2026-07-20T14:05:00Z), a definition version (retained_7d v2), ids (fnd_hbd5tecbg68m, c1, retention_by_arm, unique_users), a file path (queries/retention_by_arm.sql) and an explicit non-evidence literal ({{literal:7-day}}). None of them is a measured quantity.
