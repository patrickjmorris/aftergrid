...
- Counter-metric named by that definition: {{literal:7-day}} retention, {{ref:retention_by_arm.checklist.retained_7d_rate}} in the checklist arm. Pushing habit creation with a forced onboarding step would create habits nobody comes back for; it did not here.
