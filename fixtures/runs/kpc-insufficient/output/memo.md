...
# Too early to tell whether cancellations rose after the price change
...
- Written for a general reader: this Instance keeps no named profile for whoever owns the pricing decision, so the wording assumes no data training and five minutes.
